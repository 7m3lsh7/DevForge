            ...
            return (
              <div key={member.id} className={styles.card}>
                ...
                <div className={styles.links}>
                  {githubLink && (
                    <a href={githubLink.url} target="_blank" rel="noopener noreferrer" className={styles.link} aria-label="GitHub">
                  ...
                  {linkedinLink && (
                    <a href={linkedinLink.url} target="_blank" rel="noopener noreferrer" className={styles.link} aria-label="LinkedIn">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
