...
export const teamMembers = [
  {
    ...
    bio: '8 years building enterprise-grade systems. Expert in scalable architecture and cloud-native solutions.',
    skills: ['React', 'Node.js', 'AWS', 'PostgreSQL'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/alex.jpg',
    gradient: 'linear-gradient(135deg, #660810, #3D0509)',
    initials: 'AC',
  },
  {
    id: 2,
    ...
    bio: 'Crafting pixel-perfect interfaces with a passion for accessibility and performance optimization.',
    skills: ['Next.js', 'TypeScript', 'Figma', 'CSS'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/sarah.jpg',
    gradient: 'linear-gradient(135deg, #8A0A14, #660810)',
    initials: 'SM',
  },
  {
    id: 3,
    ...
    bio: 'Infrastructure expert with deep knowledge in microservices, containerization, and CI/CD pipelines.',
    skills: ['Python', 'Docker', 'Kubernetes', 'Redis'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/marcus.jpg',
    gradient: 'linear-gradient(135deg, #3D0509, #660810)',
    initials: 'MJ',
  },
  {
    id: 4,
    ...
    bio: 'Bridging design and code to create intuitive user experiences that convert and retain users.',
    skills: ['Figma', 'React', 'Motion Design', 'Prototyping'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/lena.jpg',
    gradient: 'linear-gradient(135deg, #660810, #8A0A14)',
    initials: 'LZ',
  },
  {
    id: 5,
    ...
    bio: 'Building cross-platform mobile applications with React Native and Flutter for 6+ years.',
    skills: ['React Native', 'Flutter', 'iOS', 'Android'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/david.jpg',
    gradient: 'linear-gradient(135deg, #8A0A14, #3D0509)',
    initials: 'DO',
  },
  {
    id: 6,
    ...
    bio: 'Ensuring bulletproof quality through automated testing, security audits, and performance benchmarking.',
    skills: ['Cypress', 'Jest', 'Selenium', 'OWASP'],
    github: 'https://github.com',
    linkedin: 'https://linkedin.com',
    avatar: '/team/nina.jpg',
    gradient: 'linear-gradient(135deg, #3D0509, #8A0A14)',
    initials: 'NP',
  },
];
